...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry) -> bool:
    ...
    manager = InMetEntityManager(hass, config_entry, radius)
...
class InMetEntityManager:
    ...
    def __init__(
        ...
        self._status_info: str | None = None
    ...
    def get_entry(self, external_id: str) -> str | None:
        """Get feed entry by external id."""
        # return self._feed_manager.feed_entries.get(external_id)
        # TODO
        return f"{external_id}_get_entry"
    ...
    async def _update_entity(self, external_id: str) -> None:
        """Update entity."""
        async_dispatcher_send(self._hass, f"inmet_update_{external_id}")

    async def _remove_entity(self, external_id: str) -> None:
        """Remove entity."""
        async_dispatcher_send(self._hass, f"inmet_delete_{external_id}")

    async def _status_update(self, status_info: str) -> None:
